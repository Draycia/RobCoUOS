...
os_call_vectors:
	...
	jmp os_newline_string	; 00D2h
	jmp os_read_string		; 00D5h
	jmp os_conv_mem			; 00D8h
	jmp os_upper_mem		; 00DBh
	jmp os_hack_input		; 00DEh
...
no_change:
	...
	mov ax, 1003h		; to be bright, and with blinking
	mov bl, 01h
	mov bh, 00h
	int 10h
	...
	call os_seed_random		; Seed random number generator -why is this line included?-
